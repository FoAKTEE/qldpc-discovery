...
def validate_cmd(argv=None) -> int:
    ...
    p.add_argument("--catalog", default="ref-paper/arxiv-2606.02418/src/%(type)s_catalog_tables.tex")
    ...
    catalog = Path(a.catalog % {"type": a.type})
    rep = validate(payload["discoveries"], catalog if catalog.exists() else None, kind=a.type)
