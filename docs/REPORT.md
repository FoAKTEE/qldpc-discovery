...
**Scientific report** — what this package reproduces, the verified results, and honest limitations.
...
## Verified results (closed-loop; `tests/`, 54 tests)
...
qcode-discover --type css --distance-method bposd --stage3-verify   # blind discovery campaign
qcode-validate --type css                                    # post-hoc, vs landmarks (or --catalog)
```
See [usage.md](usage.md), [architecture.md](architecture.md), and [EXTENDING.md](EXTENDING.md).
