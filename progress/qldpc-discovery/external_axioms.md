...
| `ax:bb-construction` | BB H_X=(A\|B),H_Z=(B^T\|A^T) is a valid CSS code; gross [[144,12,12]] | whole pipeline | bravyi2024high = arXiv:2308.07915 (ACQUIRED) | `[REPLACED-BY-EXTERNAL-AXIOM]` — ref-paper/arxiv-2308.07915/ acquired; construction re-verified in `bb_codes` |
